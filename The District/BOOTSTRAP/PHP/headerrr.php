                ...
                <div class="container-fluid justify-content-evenly">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 topnav-centered">
                            <li class="nav-item">
                                <a class="nav-link mx-md-4 <?php if ($_SERVER['REQUEST_URI'] == "/PHP/Accueil.php") {
                                                                echo "active";
                                                            } ?> espace" href="Accueil.php">ACCUEIL</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mx-md-4 <?php if (
                                                                $_SERVER['REQUEST_URI'] == "/PHP/categorie.php" || $_SERVER['REQUEST_URI'] == "/PHP/Asiatique.php" || $_SERVER['REQUEST_URI'] == "/PHP/Burger.php" || $_SERVER['REQUEST_URI'] == "/PHP/Pasta.php" || $_SERVER['REQUEST_URI']
                                                                == "/PHP/Pizza.php" || $_SERVER['REQUEST_URI'] == "/PHP/Salade.php" || $_SERVER['REQUEST_URI'] == "/PHP/Sandwich.php" || $_SERVER['REQUEST_URI'] == "/PHP/Veggie.php" || $_SERVER['REQUEST_URI'] == "/PHP/Wrap.php"
                                                            ) {
                                                                echo "active";
                                                            } ?> espace " href="categorie.php">CATEGORIE</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mx-md-4 <?php if ($_SERVER['REQUEST_URI'] == "/PHP/plats.php") {
                                                                echo "active";
                                                            } ?> espace " href="plats.php">PLATS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mx-md-4 <?php if ($_SERVER['REQUEST_URI'] == "/PHP/Contact.php") {
                                                                echo "active";
