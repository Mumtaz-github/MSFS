...
foreach ($result as $category) {
  if ($i == 1) {
    echo '<div id="page1">
                    <div class="container"> 
                            <div class="fs-1 texte ms-md-4 text-white text-center">Toute les catégories :</div><br>
                              <div class="row justify-content-between mt-3">';
  } elseif ($i == 7) {
    echo '<div id="page2">
                    <div class="container"> 
                            <div class="fs-1 texte ms-md-4"> :</div><br>
                              <div class="row justify-content-between mt-3">';
  };
  echo '<div class="card col-12 col-sm-4 col-md-4 mt-3 mx-auto">
                                    ...
                                    <img src="img/' . $category['image'] . '" class="card-img-top imagecat" alt="' . $category['libelle'] . 'food">
                                    <div class="card-body">
