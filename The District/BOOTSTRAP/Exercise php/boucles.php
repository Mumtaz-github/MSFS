...
<body>
    <!-- ****1 partie: script php qui affiche tous les nombres impairs entre 0 et 150, order croissant**** -->
...
<!--*************2em partie: programme qui écrit 500 fois la phrase*****************  -->
...
<!--******** 3em partie:script affiche la table de multiplication pour les nombres de 1 à 9********** -->
